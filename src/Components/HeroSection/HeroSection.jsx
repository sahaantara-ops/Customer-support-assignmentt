...
<div className= "grid grid-cols-2 W-[1440px]">
  <div className='mt-25 ml-18 p-6'>
    ...
    <h3 className= "text-white text-4xl bold flex justify-center pt-24">InProgress</h3>
    <h3 className= "text-white text-4xl center flex justify-center">{InProgress} </h3>
